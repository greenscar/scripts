...
#$SOURCE_FILE="C:\\working\\James.G.Sandlin_SYSCONFIG_int\\IE_sysconf\\TIERS\\build_script\\props\\online.properties";
$DEST_XML="envts_online.xml";
$DEST_DIR="/var/apache/htdocs";
#$DEST_DIR="C:\temp\\xml_test";
