...
TCL_EXTRA_CFLAGS='-arch ppc -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk -mmacosx-version-min=10.4'
...
# build directory.
TCL_BUILD_LIB_SPEC='-F/Users/kevin/tcl-tk-aqua-new/build/tcl/Deployment -framework Tcl'
...
# compiled.
TCL_SRC_DIR='/Users/kevin/tcl-tk-aqua-new/tcl8.4.14'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/kevin/tcl-tk-aqua-new/build/tcl/Deployment -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Library/Frameworks/Tcl.framework/Versions/8.4 -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/kevin/tcl-tk-aqua-new/build/tcl/Deployment/libtclstub8.4${TCL_DBGX}.a'
