package Environments::Schema::Result::V_Environments;
...
__PACKAGE__->belongs_to(
                           database => 'Environments::Schema::Result::V_Ad_Instances', 
...
# Set ResultSet Class
#
__PACKAGE__->resultset_class('Environments::Schema::ResultSet::V_Environments');
