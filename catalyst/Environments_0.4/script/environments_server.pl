...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{ENVIRONMENTS_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{ENVIRONMENTS_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
environments_server.pl - Catalyst Testserver

=head1 SYNOPSIS

environments_server.pl [options]
