package Environments::Schema::Result::V_Ad_Instances;
...
__PACKAGE__->belongs_to(server => 'Environments::Schema::Result::V_Ad_Hosts', 'host_id');

__PACKAGE__->has_many(
                        environments => 'Environments::Schema::Result::V_Environments', 
