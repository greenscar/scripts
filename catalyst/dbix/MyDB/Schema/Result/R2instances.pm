package MyDB::Schema::Result::R2instances;
...
__PACKAGE__->has_many(
  "r2deployments",
  "MyDB::Schema::Result::R2deployments",
  { "foreign.instance" => "self.id" },
);
__PACKAGE__->belongs_to(
  "environment",
  "MyDB::Schema::Result::R2environments",
  { id => "environment" },
);
__PACKAGE__->belongs_to(
  "application",
  "MyDB::Schema::Result::R2applications",
  { id => "application" },
);
...
# Set ResultSet Class
__PACKAGE__->resultset_class('MyDB::Schema::ResultSet::R2instances');
