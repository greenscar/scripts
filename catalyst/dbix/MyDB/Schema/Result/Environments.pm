package MyDB::Schema::Result::Environments;
...
# Set ResultSet Class
#
__PACKAGE__->resultset_class('MyDB::Schema::ResultSet::Environments');

__PACKAGE__->has_many(
  "instances",
  "MyDB::Schema::Result::Instances",
  { "foreign.environments_id" => "self.id" },
);

#__PACKAGE__->has_many(
#   "deployments",
#   "MyDB::Schema::Result::Deployments",
#  { "foreign.environments_id" => "self.id" },
#);
