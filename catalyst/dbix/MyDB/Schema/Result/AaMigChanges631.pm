package MyDB::Schema::Result::AaMigChanges631;
...
__PACKAGE__->table("aa_mig_changes_631");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vY6/h02oR9ZgrZ6BNN+nAQ
...
__PACKAGE__->might_have(
                           file => 'MyDB::Schema::Result::Stage_Merge',
                           { 'foreign.tiers_id' => 'self.tiers_id' }
                       );

#__PACKAGE__->many_to_many(file => 'MyDB::Schema::Result::Stage_Merge','tiers_id');
