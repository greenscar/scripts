...
rem Run buildHB321.bat from the same directory.
rem -----------------------------------------------------------------------------------------
...
SET AUTOMATION_HOME=C:\views\vnandrambakkam01_EA_HB321_73_2_x_x\EA_hb321\BuildScript
...
"C:\IBM\SDP70\runtimes\bi_v61\bin\ws_ant.bat" -f windows_build.xml %1
ant %* 
