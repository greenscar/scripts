...
SET AUTOMATION_HOME=C:\views\vnandrambakkam01_MEPD_74_0_0_0\EA_mepd1\BuildScripts_MEPDScaServiceGateway
rem Environment like Mark,Cola,Last,Prod
SET ENVIRONMENT=Cola
...
SET MODULE_LIST=EADADSListenerProc
rem -----------------------------------------------------------------------------------------
rem
