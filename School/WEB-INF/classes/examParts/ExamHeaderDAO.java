...
public class ExamHeaderDAO{
    ...
    public ExamHeaderDAO(int eNum, String examName, String catCode, int creator, 
        ...
        dbUtil = new DBUtil();
        log = new Secretary();
        this.headerVO.setExamNum(eNum);
        log.write("ExamHeader.examNum = " + this.examNum);
        this.headerVO.setExamName = examName;
        this.categoryDAO = new ExamCatDAO(catCode);
        this.headerVO.setCreatorEmpNum = creator;
        this.headerVO.setDateCreated = date;
        this.headerVO.setDateLastMod = date;
        this.headerVO.setIsActive = isActive;
        this.headerVO.setDisplayAfterTaking = disp;
        this.createPreparedStatements();
    }
    public ExamHeaderDAO(int eNum){
        dbUtil = new DBUtil();
        log = new Secretary();
        this.examNum = eNum;
        this.createPreparedStatements();
